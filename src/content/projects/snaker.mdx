...
import rainbowCover from "./rainbow-cover.png";
import noTreads from "./no-treads.png";

**Play Snaker in your browser:** [https://boringbydesign.ca/snaker](https://boringbydesign.ca/snaker)
...
<Image
  src={rainbowCover}
  alt="Cover of the January 1984 issue of The Rainbow magazine"
...
<Image
  src={noTreads}
  alt="First page of the Snaker article and source listing as printed in The Rainbow"
  sizes="(min-width: 770px) 722px, calc(100vw - 3rem)"
/>
...
**Play it in your browser:** [https://boringbydesign.ca/snaker](https://boringbydesign.ca/snaker)
