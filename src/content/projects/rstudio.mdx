...
import rstudioAssistant from "./rstudio.png";
...
The majority of the user interface is built using the [Google Web Toolkit (GWT)](https://github.com/gwtproject/gwt)
...
<Image
  src={rstudioAssistant}
  alt="RStudio IDE with the Posit Assistant pane open in the sidebar"
