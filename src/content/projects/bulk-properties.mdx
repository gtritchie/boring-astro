...
import optionsDialog from "./bulk-properties-options.png";
import editDialog from "./bulk-properties-edit.png";
...
<Image
  src={optionsDialog}
  alt="Bulk Properties options dialog for choosing the selection and editable properties"
...
<Image
  src={editDialog}
  alt="Bulk edit dialog showing a property selector and new-value field for the selected notes"
  sizes="(min-width: 770px) 722px, calc(100vw - 3rem)"
/>
